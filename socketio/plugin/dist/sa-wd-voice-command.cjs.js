...
var RecordRTC__namespace = /*#__PURE__*/_interopNamespaceDefault(RecordRTC);
...
class SAWDVoiceCommand {
    ...
    record() {
        if (this.stream) {
            this.recorder = new RecordRTC__namespace.StereoAudioRecorder(this.stream, {
                type: 'audio',
                mimeType: 'audio/wav',
...
module.exports = SAWDVoiceCommand;
